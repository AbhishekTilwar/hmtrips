...
export default function GuidanceModal({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 overflow-y-auto safe-area-inset-top safe-area-inset-bottom">
      ...
      />
      <div
        className="relative w-full max-w-md rounded-2xl bg-pink-50/95 border border-pink-200/80 shadow-2xl p-6 md:p-8 my-auto max-h-[90vh] overflow-y-auto"
        role="dialog"
        aria-modal="true"
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <a
              href="#login"
              onClick={handleClose}
              className="w-full min-h-[44px] md:min-h-0 py-3.5 px-6 rounded-xl font-medium text-center text-violet-700 hover:bg-pink-100/80 transition-colors inline-flex items-center justify-center gap-2"
            >
